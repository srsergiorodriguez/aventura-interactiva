...
}`,x_=G(`<div class="option-row svelte-181dlmc"><input type="text"/> <button class="btn btn-danger">x</button></div>`),S_=G(`<div class="image-preview-mini svelte-181dlmc"><img alt="preview" class="svelte-181dlmc"/> <button class="btn btn-danger w-full mt-1"> </button></div> <button class="btn btn-primary w-full mt-1"> </button>`,1),C_=G(`<label class="btn btn-secondary w-full file-upload-btn svelte-181dlmc"> <input type="file" accept="image/*" hidden=""/></label>`),w_=G(`<div class="control-group svelte-181dlmc"><label class="svelte-181dlmc"> </label> <input type="text" style="width: 100%; box-sizing: border-box; padding: 0.5rem; font-family: monospace;"/></div>`),T_=G(`<div class="editor-panel svelte-181dlmc"><h3 class="ui-section-title"> </h3> <div class="control-group svelte-181dlmc"><label class="svelte-181dlmc"> </label> <textarea rows="6"></textarea></div> <div class="control-group svelte-181dlmc"><label class="svelte-181dlmc"> </label> <!> <button class="btn btn-secondary w-full mt-1"> </button></div> <div class="control-group svelte-181dlmc"><label class="svelte-181dlmc"> </label> <!></div> <!> <button class="btn btn-secondary w-full" style="border-style: dashed; margin-top: 2rem;"> </button></div>`),E_=G(`<div class="creator-panel svelte-181dlmc"><h3 class="ui-section-title"> </h3> <div class="control-group svelte-181dlmc"><input type="text" placeholder="scene_name"/> <button class="btn btn-secondary w-full mt-1"> </button></div></div>`),D_=G(`<aside class="sidebar svelte-181dlmc"><div class="sidebar-header svelte-181dlmc"><div class="header-top svelte-181dlmc"><div><h1 class="svelte-181dlmc">aventura interactiva</h1> <p class="svelte-181dlmc">v2</p></div> <div class="lang-toggle" style="display: flex; gap: 0.5rem;"><button style="padding: 0.1rem 0.4rem;">EN</button> <button style="padding: 0.1rem 0.4rem;">ES</button></div></div> <button class="btn btn-primary w-full mt-1"> </button> <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; margin-top: 0.25rem;"><button class="btn btn-secondary"> </button> <button class="btn btn-secondary"> </button></div></div> <div class="sidebar-content svelte-181dlmc"><!></div> <footer class="sidebar-footer svelte-181dlmc"><div class="io-grid svelte-181dlmc"><label class="btn btn-secondary io-btn svelte-181dlmc"> <input type="file" accept=".json" hidden=""/></label> <button class="btn btn-secondary io-btn svelte-181dlmc"> </button> <button class="btn btn-primary io-btn btn-export svelte-181dlmc"> </button></div> <div class="credits" style="text-align: center; margin-top: 1rem; font-size: 0.75rem; opacity: 0.7;"> <strong>Aventura</strong> | <a href="https://github.com/srsergiorodriguez/aventura" target="_blank" style="color: inherit;"> </a></div></footer></aside> <!> <!> <!> <!>`,1);function O_(e,t){j(t,!0);let n=F(``),r=F(!1),i=F(!1),a=F(!1),o=F(!1),s=P(()=>$.nodes.find(e=>e.id===$.selectedNodeId));function c(){tg(U(n)),I(n,``)}function l(e){ng({text:e.target.value})}function u(){ng({options:[...U(s).data.options||[],{btn:`new option`}]})}function d(e,t){let n=[...U(s).data.options];n[e].btn=t,ng({options:n})}function f(e){ng({options:U(s).data.options.filter((t,n)=>n!==e)})}async function p(e){let t=e.target.files[0];if(t)try{ng({image:await fg(t)})}catch{alert(`failed to process image`)}}function m(){let e=rg();pg(JSON.stringify(e,null,2),`historia_aventura.json`,`application/json`)}function h(e){let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{ig(JSON.parse(e.target.result)),$.selectedNodeId=null}catch{alert(`Failed to parse JSON file!`)}},n.readAsText(t),e.target.value=``}function g(){if($.nodes.length===0)return alert(`no scenes to export!`);let e=rg(),t=mg($.nodes);pg(hg(y_,e,$.options,t,Q.lang,b_),`juego_aventura.html`,`text/html`)}var _=D_(),v=R(_),y=L(v),b=L(y),x=z(L(b),2),S=L(x),C=z(S,2);A(x),A(b);var w=z(b,2),T=L(w,!0);A(w);var ee=z(w,2),E=L(ee),te=L(E,!0);A(E);var ne=z(E,2),D=L(ne,!0);A(ne),A(ee),A(y);var re=z(y,2),ie=L(re),ae=e=>{var t=T_(),n=L(t),i=L(n);A(n);var a=z(n,2),o=L(a),c=L(o,!0);A(o);var m=z(o,2);Cn(m),A(a);var h=z(a,2),g=L(h),_=L(g,!0);A(g);var v=z(g,2);pi(v,17,()=>U(s).data.options||[],li,(e,t,n)=>{var r=x_(),i=L(r);qi(i);var a=z(i,2);A(r),B(()=>Ji(i,U(t).btn)),W(`input`,i,e=>d(n,e.target.value)),W(`click`,a,()=>f(n)),K(e,r)});var y=z(v,2),b=L(y,!0);A(y),A(h);var x=z(h,2),S=L(x),C=L(S,!0);A(S);var w=z(S,2),T=e=>{var t=S_(),n=R(t),i=L(n),a=z(i,2),o=L(a,!0);A(a),A(n);var c=z(n,2),l=L(c,!0);A(c),B((e,t)=>{Y(i,`src`,U(s).data.image),q(o,e),q(l,t)},[()=>Q.t(`btn_remove_img`),()=>Q.t(`btn_edit_areas`)]),W(`click`,a,()=>ng({image:null,areas:[]})),W(`click`,c,()=>I(r,!0)),K(e,t)},ee=e=>{var t=C_(),n=L(t),r=z(n);A(t),B(e=>q(n,`${e??``} `),[()=>Q.t(`btn_upload_img`)]),W(`change`,r,p),K(e,t)};J(w,e=>{U(s).data.image?e(T):e(ee,-1)}),A(x);var E=z(x,2),te=e=>{var t=w_(),n=L(t),r=L(n,!0);A(n);var i=z(n,2);qi(i),A(t),B((e,t)=>{q(r,e),Y(i,`placeholder`,t),Ji(i,U(s).data.igrama||``)},[()=>Q.t(`igrama_rule`),()=>Q.t(`igrama_placeholder`)]),W(`input`,i,e=>ng({igrama:e.target.value})),K(e,t)};J(E,e=>{$.options.igrama&&e(te)});var ne=z(E,2),D=L(ne,!0);A(ne),A(t),B((e,t,n,r,a,o)=>{q(i,`${e??``} ${U(s).id??``}`),q(c,t),Ji(m,U(s).data.text),q(_,n),q(b,r),q(C,a),q(D,o)},[()=>Q.t(`editing`),()=>Q.t(`text`),()=>Q.t(`options`),()=>Q.t(`add_option`),()=>Q.t(`image`),()=>Q.t(`back_canvas`)]),W(`input`,m,l),W(`click`,y,u),W(`click`,ne,()=>$.selectedNodeId=null),K(e,t)},oe=e=>{var t=E_(),r=L(t),i=L(r,!0);A(r);var a=z(r,2),o=L(a);qi(o);var s=z(o,2),l=L(s,!0);A(s),A(a),A(t),B((e,t)=>{q(i,e),q(l,t)},[()=>Q.t(`add_scene`),()=>Q.t(`btn_create`)]),W(`keydown`,o,e=>e.key===`Enter`&&c()),ta(o,()=>U(n),e=>I(n,e)),W(`click`,s,c),K(e,t)};J(ie,e=>{U(s)?e(ae):e(oe,-1)}),A(re);var se=z(re,2),ce=L(se),le=L(ce),ue=L(le),de=z(ue);A(le);var fe=z(le,2),pe=L(fe,!0);A(fe);var me=z(fe,2),he=L(me,!0);A(me),A(ce);var ge=z(ce,2),_e=L(ge),ve=z(_e,3),ye=L(ve,!0);A(ve),A(ge),A(se),A(v);var be=z(v,2);t_(be,{get isOpen(){return U(i)},onClose:()=>I(i,!1)});var xe=z(be,2);Cg(xe,{get isOpen(){return U(r)},get nodeData(){return U(s)},onSave:e=>ng({areas:e}),onClose:()=>I(r,!1)});var Se=z(xe,2);a_(Se,{get isOpen(){return U(a)},onClose:()=>I(a,!1)}),v_(z(Se,2),{get isOpen(){return U(o)},onClose:()=>I(o,!1)}),B((e,t,n,r,i,a,o,s)=>{ji(S,1,`btn ${Q.lang===`en`?`btn-primary`:`btn-secondary`}`),ji(C,1,`btn ${Q.lang===`es`?`btn-primary`:`btn-secondary`}`),q(T,e),q(te,t),q(D,n),q(ue,`${r??``} `),q(pe,i),q(he,a),q(_e,`${o??``} `),q(ye,s)},[()=>Q.t(`test_story`),()=>Q.t(`grammar_editor`),()=>Q.t(`engine_opts`),()=>Q.t(`load_json`),()=>Q.t(`save_json`),()=>Q.t(`export_html`),()=>Q.t(`powered_by`),()=>Q.t(`source_code`)]),W(`click`,S,()=>Q.lang=`en`),W(`click`,C,()=>Q.lang=`es`),W(`click`,w,()=>I(i,!0)),W(`click`,E,()=>I(o,!0)),W(`click`,ne,()=>I(a,!0)),W(`change`,de,h),W(`click`,fe,m),W(`click`,me,g),K(e,_),M()}Kr([`click`,`input`,`change`,`keydown`]);var k_=da(()=>$),A_=G(`<!> <!> <!>`,1),j_=G(`<div class="app-layout svelte-1fg37ex"><div class="workspace-wrapper svelte-1fg37ex"><!></div> <!></div>`);function M_(e,t){j(t,!1);let n={sceneNode:dg};function r(e){let t=k_().edges.filter(t=>!(t.source===e.source&&t.sourceHandle===e.sourceHandle));k_(k_().edges=xf(e,t))}la();var i=j_(),a=L(i);xh(L(a),{get nodeTypes(){return n},fitView:!0,onpaneclick:()=>k_(k_().selectedNodeId=null),onconnect:r,proOptions:{hideAttribution:!0},get nodes(){return k_().nodes},set nodes(e){k_(k_().nodes=e)},get edges(){return k_().edges},set edges(e){k_(k_().edges=e)},get viewport(){return k_().viewport},set viewport(e){k_(k_().viewport=e)},children:(e,t)=>{var n=A_(),r=R(n);Wh(r,{variant:`dots`,gap:20,size:1,color:`#cccccc`});var i=z(r,2);Ih(i,{showInteractive:!1}),$h(z(i,2),{nodeColor:`#000`,maskColor:`rgba(255, 255, 255, 0.8)`}),K(e,n)},$$slots:{default:!0},$$legacy:!0}),A(a),O_(z(a,2),{}),A(i),K(e,i),M()}var N_=G(`<main><!></main>`);function P_(e,t){j(t,!0),Nn(()=>{eg()});var n=N_();M_(L(n),{}),A(n),K(e,n),M()}ri(P_,{target:document.getElementById(`app`)});